...
BYTE VolumeChangeEntrySequence [5] = {LIGHT_GRABBER_1P_BUTTON,FLIP_FLOP_BUTTON,LIGHT_GRABBER_2P_BUTTON,TEATHER_BALL_BUTTON,LIGHT_GRABBER_1P_BUTTON};
BYTE VolumeChangeEntrySequencePosition = 0;


BYTE GameCountEntrySequence [5] = {FLIP_FLOP_BUTTON,FLIP_FLOP_BUTTON,FLIP_FLOP_BUTTON,FLIP_FLOP_BUTTON,FLIP_FLOP_BUTTON};
