...
//		SPI1CON = 0x023F;		/*  Master mode, prescale 1:1 */
//		/* CKE=0 CKP =0 SMP=1 to sample SDI on rising edge */
//		/* SPI Speed running at full 16.384MHz */
//		SPI1STATbits.SPISIDL=1;	 /* discontinue operating in idle */
//		SPI1STATbits.SPIROV=0;
//		SPI1STATbits.SPIEN=1;	/* enable SPI */
//		ConfigIntSPI1(SPI_INT_EN & SPI_INT_PRI_5);	/* enable interrupt */
