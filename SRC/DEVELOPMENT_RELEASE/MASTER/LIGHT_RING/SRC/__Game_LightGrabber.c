			...
			if(button == P1_CurrentLightToGrab)
				{
					...
					if(BonusActive == TRUE)
					{
						P1_CurrentLightToGrab = RandomButton(BonusLocation,button,NO_EXCLUDE);
					}
					else
					{
			...
			if(button == P1_CurrentLightToGrab)
				{
					...
					{
						P1_CurrentLightToGrab = RandomButton(P2_CurrentLightToGrab,button,NO_EXCLUDE);
					}
			...
			if(button == P2_CurrentLightToGrab)
				{
					...
					{
						P2_CurrentLightToGrab = RandomButton(P1_CurrentLightToGrab,button,NO_EXCLUDE);
					}
