...
namespace NEOSUSBMessages
{
    public static class SystemModes
    {
        public const byte  GAME_ACTIVE 	        = 0x00;
        public const byte  USB_FLASH_UPDATE		= 0x01;
        public const byte  SYSTEM_IDLE			= 0x02;
        public const byte  SYSTEM_SOFTWARE_RESET= 0x03;
        public const byte  SYSTEM_DIAGNOSTICS   = 0x04;
    }
